                ...
                <div id='post-details-panel' class='floating-panel hidden'>
                    <div class='floating-panel-content ui-widget'>
                        ...
                        <div id='details-left-column' class='panel-post-column scroll-y'>
                            ...
                            <div id='post-no-image-desc' class='floating-panel-section hint hidden'>
                                <b>Hint:</b> Sometimes posts have photos, but the owner of the post hasn't allowed apps like Swapper's Delight access to them. Click <a target='_blank' class='post-permalink wrappable-link'>here</a> to see the post directly in Facebook.
                            </div>
                        </div>
