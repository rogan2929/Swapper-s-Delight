...
//            })($('div.post-tile'));
    ...
    showPostDetails: function(post) {
        ...
        $('#post-message-header .wrapper .timestmap').text(timeStamp.calendar());
