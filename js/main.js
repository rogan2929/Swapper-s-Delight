...
var SwdView = {
    ...
    displayGroupFeed: function(feed, postType) {
        ...
        for (i = 0; i < feed.length; i++) {
            ...
            $('#feed-posts').append('<li class="post-tile"><div class= "ui-widget ui-widget-content"><div class="post-image"><img src="' + url + '"></div><div class="post-caption">' + feed[i].message + '</div></div></li>');
        }
    },
    /***
