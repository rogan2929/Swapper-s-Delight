...
var SwdView = {
    ...
    createTextPostBlock: function(post) {
        ...
        message = '<div class="wrapper"><p class="content"><span class="user-image" style="background-image: ' + userImage + '"></span><span class="user-name">' + post.user.first_name + ' ' + post.user.last_name + '</span><span class="timestamp">' + timeStamp + '</span>' + post.message + '</p></div>';
