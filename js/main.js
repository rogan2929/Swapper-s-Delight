...
var SwdView = {
    ...
    addPostComment: function(comment) {
        ...
        commentDiv = $('<div class="post-comment"><a href="' + comment.user.profile_url + '">' + comment.user.first_name + ' ' + comment.user.last_name + '</a><div class="timestamp">' + timeStamp.calendar() + '</div><div class="post-comment-text">' + comment.text + '</div></div>');
