                            ...
                            success: function(response) {
                                ...
                                setTimeout(function() {
                                    if ($('.ad-div').filter(':visible').length === 0) {
                                        alert("It looks like you're using an ad blocker of some kind. Please consider turning it off for this app, as it's the only way I pay for hosting costs and am compensated for my work. Thank you!");
                                    }
                                }, 3000);
