    ...
    showPostDetails: function(post) {
        ...
        if (post.comments.length > 0) {
            ...
            for (i = 0; i < post.comments.length; i++) {
                ...
                comment = $('<div class="post-comment ui-corner-all ui-widget ui-widget-content"><div class="ui-state-default"><div class="post-comment-user-image"></div><div class="post-comment-header"><p><a class="post-comment-user-name" href="' + post.comments[i].user.profile_url + '" target="_blank">' + post.comments[i].user.first_name + ' ' + post.comments[i].user.last_name + '</a><span class="timestamp">' + timeStamp.calendar() + '</span></p></div></div>' + post.comments[i].text + '</div>');
