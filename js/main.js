        ...
        if (posts) {
            for (i = 0; i < posts.length; i++) {
                ...
                if (!(noImage && noMessage)) {
                    $(feedContainer).append('<li id="' + post.post_id + '" class="post-tile ui-widget ui-widget-content"><div class="post-image"><img src="' + url + '"></div><div class="post-caption ellipses"><div><p>' + message + '</p></div></div></li>');
                }
            }
