...
var SwdView = {
    ...
    addPostComment: function(comment) {
        ...
        commentDiv = $('<div class="post-comment"><div><a href="' + comment.user.profile_url + '">' + comment.user.first_name + ' ' + comment.user.last_name + '</a><div class="timestamp">' + timeStamp.calendar() + '</div></div><div class="post-comment-text">' + comment.text + '</div></div>');
