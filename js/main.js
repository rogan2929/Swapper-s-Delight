...
var SwdView = {
    ...
    addGroupsToSelectPanel: function(groups) {
        ...
        for (i = 0; i < groups.length; i++) {
            $('#select-group-list').append('<div id="' + groups[i].gid + '" class="button selection-item select-group"><div class="selection-item-content"><div><span class="button-icon" style="background-image: url(' + groups[i].icon + ')"></span></div><div>' + groups[i].name + '</div></div></div>');
        }
    },
