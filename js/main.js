...
var SwdView = {
    ...
    displayGroupFeed: function(feed, postType) {
        ...
        for (i = 0; i < feed.length; i++) {
            ...
            $('#feed-posts').append('<li id="' + feed[i].id + '" class="post-tile"><div class="ui-widget post-container"><input type="checkbox" name="vehicle" value="Bike"><div class="post-image"><img src="' + url + '"></div><div class="post-caption">' + feed[i].message + '</div></div></li>');
        }
    },
    /***
