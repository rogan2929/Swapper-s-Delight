...
class DataAccessLayer {
    ...
    public function postComment($postId, $comment) {
        ...
        $queries = array(
            'commentQuery' => 'SELECT fromid,text,text_tags,attachment,time,object_id FROM comment WHERE id=' . $id['id'],
    ...
    public function getPostDetails($postId) {
        $queries = array(
            ...
            'commentsQuery' => 'SELECT fromid,text,text_tags,attachment,time,object_id FROM comment WHERE post_id IN (SELECT post_id FROM #detailsQuery) ORDER BY time ASC',
